...
The system SHALL allow the user to mark an existing active task as completed. Once completed, the task MUST remain visible in the task list with its completed state reflected.
